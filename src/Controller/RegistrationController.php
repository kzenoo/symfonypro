...
class RegistrationController extends AbstractController
{
    ...
    public function register(Request $request, UserPasswordHasherInterface $userPasswordHasher, UserAuthenticatorInterface $userAuthenticator, AuthentificationAuthenticator $authenticator, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->emailVerifier->sendEmailConfirmation('app_verify_email', $user,
                (new TemplatedEmail())
                    ->from(new Address('symfony.server@symfonypro.com', 'symfonypro bot'))
                    ->to($user->getId())
    ...
    public function verifyUserEmail(Request $request, TranslatorInterface $translator, UserSecurityRepository $userSecurityRepository): Response
    {
        ...
        $user = $userSecurityRepository->find($id);
